      ...
      appBar: AppBar(
        ...
        title: Text(
          (manager?.managerName != null)
              ? "${manager?.managerName}' Team"
              : (manager?.departmentName != null)
              ? "${manager?.departmentName}' Employee"
              : "All Employee",
              ...
              if (value == "department" && departments!.isNotEmpty) {
                ...
                if (selected != null) {
                  context.read<EmployeeBloc>().add(
                    FetchEmployees(departmentName: selected['name'],adminId: args.adminId),
                  );
                                ...
                                (_, index) => ListTile(
                                  ...
                                  onTap:
                                      () => Navigator.pop(context, {
                                        ...
                                        "depart": managers[index].departmentName,
                                      }),
                                ),
                          ),
                        ),
                    ...
                    return Dismissible(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(employee.managerName ?? ""),
                        ),
                      ),
                    );
                  },
